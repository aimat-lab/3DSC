...
def MAGPIE_features(chem_formulas):
    ...
    """
    from chemml.chem.magpie_python import CompositionEntry, ValenceShellAttributeGenerator, \
        ElementalPropertyAttributeGenerator, StoichiometricAttributeGenerator, IonicityAttributeGenerator
    ...
    # Same features as in 2017 Stanev.
    feature_generators = [ValenceShellAttributeGenerator(), ElementalPropertyAttributeGenerator(), StoichiometricAttributeGenerator(), IonicityAttributeGenerator()]
